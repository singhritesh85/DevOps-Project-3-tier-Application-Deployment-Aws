...
subnet_id = "subnet-0XXXXXXXXXXXXXXXa"
#vpc_security_group_ids = ["sg-00cXXXXXXXXXXXXX9"]
cidr_blocks = ["0.0.0.0/0"]
instance_type = [ "t3.micro", "t3.small", "t3.medium", "t3.large", "t3.xlarge" ]
name = "Jenkins"

kms_key_id = "arn:aws:kms:us-east-2:0XXXXXXXXXXXX6:key/XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXXXXX"   ### Provide the ARN of KMS Key.
...
subnets = ["subnet-XXXXXXXXXXXXXXXXX", "subnet-XXXXXXXXXXXXXXX", "subnet-XXXXXXXXXXXXXXX"]
...
certificate_arn = "arn:aws:acm:us-east-2:0XXXXXXXXXXXX6:certificate/XXXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX"
