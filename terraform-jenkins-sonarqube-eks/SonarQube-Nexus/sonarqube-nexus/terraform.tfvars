...
kms_key_id = "arn:aws:kms:us-east-2:0XXXXXXXXXXX6:key/XXXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXX"   ### Provide the ARN of KMS Key.
...
certificate_arn = "arn:aws:acm:us-east-2:0XXXXXXXXXX6:certificate/XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXXX"
...
############################################### RDS DB Instance Parameters ###############################################
  ...
  rds_subnet_group = ["subnet-XXXXXXXXXXXXXX", "subnet-XXXXXXXXXXXXXXX", "subnet-XXXXXXXXXXXXXXX", "subnet-XXXXXXXXXXXXX", "subnet-XXXXXXXXXXXXXX", "subnet-XXXXXXXXXXXXXXX"]
...
#  backup_retention_period = 7   ### For Demo purpose I am not creating any db backup.
  kms_key_id_rds = "arn:aws:kms:us-east-2:0XXXXXXXXXXX6:key/XXXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXX"
